      ...
      <div className="w-full md:w-1/2 p-4">
        ...
        <div className="mt-4 grid grid-cols-2">
          <div className="flex items-center justify-center w-[16rem] m-4">
            <img src="public/search.svg" alt="" className="w-12 h-12 mr-2" />
            <p>
          ...
          <div className="flex items-center justify-center w-[16rem] m-4">
            <img src="public/connect.svg" alt="" className="w-12 h-12 mr-2" />
            <p>
          ...
          <div className="flex items-center justify-center w-[16rem] m-4">
            <img src="public/research.svg" alt="" className="w-12 h-12 mr-2" />
            <p>
          ...
          <div className="flex items-center justify-center w-[16rem] m-4">
            <img src="public/academy.svg" alt="" className="w-12 h-12 mr-2" />
            <p>
        ...
        <div className="flex justify-between items-center">
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-2 ">
              <img
                src="public/features-1.svg"
                className="ml-12"
                alt="Image 1"
              />
              <img src="public/features-2.svg" className="ml-8" alt="Image 1" />
              <img src="public/features-3.svg" className="ml-4" alt="Image 1" />
            </div>
            <div className="flex flex-col gap-2 relative ">
              <img src="public/features-4.svg" alt="Image 1" />
              <img
                src="public/features-5.svg"
                alt="Image 1"
                className="ml-[4rem] w-[8rem] absolute right-0 top-12"
              />
            </div>
          </div>
          <img src="public/features-7.svg" alt="Image 1" />
        </div>
        <img src="public/features-6.svg" className="mb-12" alt="Image 2" />
      </div>
    </div>
  );
}
